...
describe('AppHealthPaginateApplitacionLanguagesService', () =>
{
    ...
    beforeAll(async () =>
    {
        ...
        service = module.get(AppHealthPaginateApplitacionLanguagesService);
    ...
    describe('main', () =>
    {
        test('AppHealthPaginateApplitacionLanguagesService should be defined', () =>
        {
            expect(service).toBeDefined();
        });

        test('should paginate applitacionLanguages', async () =>
        {
