...
describe('application', () =>
{
    ...
    test('/REST:POST app-health/apllications/paginate', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/apllications/paginate')
            .set('Accept', 'application/json')
            .send({
                query:
                {
    ...
    test('/REST:POST app-health/apllications/get', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/apllications/get')
            .set('Accept', 'application/json')
            .expect(200)
            .then(res =>
            {
    ...
    test('/GraphQL appHealthPaginateApllications', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    ...
                    {
                        appHealthPaginateApllications (query:$query constraint:$constraint)
                        {
                            total
                            count
                            rows
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthPaginateApllications).toEqual({
                    total: applicationSeeder.collectionResponse.length,
                    count: applicationSeeder.collectionResponse.length,
                    rows : applicationSeeder.collectionResponse.map(item => expect.objectContaining(_.omit(item, ['createdAt', 'updatedAt', 'deletedAt']))).slice(0, 5),
                });
    ...
    test('/GraphQL appHealthGetApllications', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    ...
                    {
                        appHealthGetApllications (query:$query)
                        {
                            id
                            technicalSolutionId
                            name
            ...
            .then(res =>
            {
                for (const [index, value] of res.body.data.appHealthGetApllications.entries())
                {
    ...
    test('/GraphQL appHealthUpdateApllications', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    mutation ($payload:AppHealthUpdateApllicationsInput! $query: QueryStatement)
                    {
                        appHealthUpdateApllications (payload:$payload query:$query)
                        {
                            id
                            technicalSolutionId
                            name
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthUpdateApllications[0].id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
