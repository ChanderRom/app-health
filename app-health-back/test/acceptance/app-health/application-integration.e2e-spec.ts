...
describe('application-integration', () =>
{
    ...
    test('/REST:POST app-health/application-integration/create - Got 400 Conflict, ApplicationIntegrationModality has to be a enum option of UNIDERECTIONAL, BIDIRECTIONAL', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-integration/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationIntegrationModality has to be any of this options: UNIDERECTIONAL, BIDIRECTIONAL');
            });
    });
