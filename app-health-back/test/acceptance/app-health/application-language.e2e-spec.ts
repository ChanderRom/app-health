...
describe('application-language', () =>
{
    ...
    test('/REST:POST app-health/applitacion-languages/paginate', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/applitacion-languages/paginate')
            .set('Accept', 'application/json')
            .send({
                query:
                {
    ...
    test('/REST:POST app-health/applitacion-languages/get', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/applitacion-languages/get')
            .set('Accept', 'application/json')
            .expect(200)
            .then(res =>
            {
    ...
    test('/GraphQL appHealthPaginateApplitacionLanguages', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    ...
                    {
                        appHealthPaginateApplitacionLanguages (query:$query constraint:$constraint)
                        {
                            total
                            count
                            rows
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthPaginateApplitacionLanguages).toEqual({
                    total: applicationLanguageSeeder.collectionResponse.length,
                    count: applicationLanguageSeeder.collectionResponse.length,
                    rows : applicationLanguageSeeder.collectionResponse.map(item => expect.objectContaining(_.omit(item, ['createdAt', 'updatedAt', 'deletedAt']))).slice(0, 5),
                });
    ...
    test('/GraphQL appHealthGetApplitacionLanguages', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    ...
                    {
                        appHealthGetApplitacionLanguages (query:$query)
                        {
                            id
                            version
                            score
            ...
            .then(res =>
            {
                for (const [index, value] of res.body.data.appHealthGetApplitacionLanguages.entries())
                {
    ...
    test('/GraphQL appHealthUpdateApplitacionLanguages', () =>
    {
        return request(app.getHttpServer())
            .post('/graphql')
            .set('Accept', 'application/json')
            .send({
                query: `
                    mutation ($payload:AppHealthUpdateApplitacionLanguagesInput! $query: QueryStatement)
                    {
                        appHealthUpdateApplitacionLanguages (payload:$payload query:$query)
                        {
                            id
                            version
                            score
            ...
            .then(res =>
            {
                expect(res.body.data.appHealthUpdateApplitacionLanguages[0].id).toStrictEqual('5b19d6ac-4081-573b-96b3-56964d5326a8');
            });
    });
