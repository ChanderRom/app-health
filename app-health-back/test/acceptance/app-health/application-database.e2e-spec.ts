...
describe('application-database', () =>
{
    ...
    test('/REST:POST app-health/application-database/create - Got 400 Conflict, ApplicationDatabaseTotalCollectionTables property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-database/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                totalCollectionTables: null,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabaseTotalCollectionTables must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST app-health/application-database/create - Got 400 Conflict, ApplicationDatabaseTotalCollectionTables property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-database/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                totalCollectionTables: undefined,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabaseTotalCollectionTables must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST app-health/application-database/create - Got 400 Conflict, ApplicationDatabaseSize is too large, has a maximum length of 20', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-database/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                size: 111111111111111110000,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabaseSize is too large, has a maximum length of 20');
            });
    });

    test('/REST:POST app-health/application-database/create - Got 400 Conflict, ApplicationDatabaseScore is too large, has a maximum length of 10', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-database/create')
            .set('Accept', 'application/json')
            ...
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabaseScore is too large, has a maximum length of 10');
            });
    });

    test('/REST:POST app-health/application-database/create - Got 400 Conflict, ApplicationDatabaseTotalCollectionTables is too large, has a maximum length of 10', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-database/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                totalCollectionTables: 11111111111,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationDatabaseTotalCollectionTables is too large, has a maximum length of 10');
            });
    });
    ...
    test('/REST:POST app-health/application-database/create - Got 400 Conflict, ApplicationDatabaseTotalCollectionTables must have a positive sign', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-database/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                totalCollectionTables: -1,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('The numerical value for ApplicationDatabaseTotalCollectionTables must have a positive sign, this field does not accept negative values');
            });
    });
