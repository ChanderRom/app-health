...
describe('application-infrastructure-service', () =>
{
    ...
    test('/REST:POST app-health/application-infrastructure-service/create - Got 400 Conflict, ApplicationInfrastructureServiceAvarageCostPerYear property can not to be null', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-infrastructure-service/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                avarageCostPerYear: null,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationInfrastructureServiceAvarageCostPerYear must be defined, can not be null');
            });
    });
    ...
    test('/REST:POST app-health/application-infrastructure-service/create - Got 400 Conflict, ApplicationInfrastructureServiceAvarageCostPerYear property can not to be undefined', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-infrastructure-service/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                avarageCostPerYear: undefined,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationInfrastructureServiceAvarageCostPerYear must be defined, can not be undefined');
            });
    });
    ...
    test('/REST:POST app-health/application-infrastructure-service/create - Got 400 Conflict, ApplicationInfrastructureServiceAvarageCostPerYear is too large, has a maximum length of 10', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-infrastructure-service/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                avarageCostPerYear: 11111111111,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('Value for ApplicationInfrastructureServiceAvarageCostPerYear is too large, has a maximum length of 10');
            });
    });
    ...
    test('/REST:POST app-health/application-infrastructure-service/create - Got 400 Conflict, ApplicationInfrastructureServiceAvarageCostPerYear must have a positive sign', () =>
    {
        return request(app.getHttpServer())
            .post('/app-health/application-infrastructure-service/create')
            .set('Accept', 'application/json')
            .send({
                ...mockData[0],
                avarageCostPerYear: -1,
            })
            .expect(400)
            .then(res =>
            {
                expect(res.body.message).toContain('The numerical value for ApplicationInfrastructureServiceAvarageCostPerYear must have a positive sign, this field does not accept negative values');
            });
    });
