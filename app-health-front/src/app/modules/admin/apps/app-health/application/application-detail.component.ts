...
export class ApplicationDetailComponent extends ViewDetailComponent
{
    ...
    breadcrumb: Crumb[] = [
        { translation: 'App' },
        { translation: 'appHealth.Apllications', routerLink: ['/app-health/application']},
    ...
    createForm(): void
    {
        this.fg = this.fb.group({
            ...
            architectureDiagram: ['', [Validators.required, Validators.maxLength(255)]],
            hasTenants: [false, [Validators.required]],
            hasLicensing: [false, [Validators.required]],
            costLicensesPerYear: [null, [Validators.required, Validators.maxLength(10)]],
            requestsPerDay: [null, [Validators.required, Validators.maxLength(10)]],
        });
    }
