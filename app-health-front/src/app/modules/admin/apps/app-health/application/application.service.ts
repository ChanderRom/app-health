import { AppHealthApplication, AppHealthCreateApplication, AppHealthUpdateApllications, AppHealthUpdateApplicationById } from '../app-health.types';
...
export class ApplicationService
{
    ...
    apllicationsSubject$: BehaviorSubject<AppHealthApplication[] | null> = new BehaviorSubject(null);
    ...
    */
    ...
    get apllications$(): Observable<AppHealthApplication[]>
    {
        return this.apllicationsSubject$.asObservable();
    }
    ...
    }>
    {
        return this.graphqlService
            ...
            .pipe(
                ...
                tap(data =>
                {
                    this.apllicationsSubject$.next(data.objects);
                }),
            );
    }
    ...
    update<T>(
        {
            ...
            graphqlStatement?: DocumentNode;
            object?: AppHealthUpdateApllications;
            query?: QueryStatement;
            constraint?: QueryStatement;
            headers?: GraphQLHeaders;
        } = {},
