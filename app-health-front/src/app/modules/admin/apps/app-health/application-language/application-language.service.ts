import { AppHealthApplicationLanguage, AppHealthCreateApplicationLanguage, AppHealthUpdateApplicationLanguageById, AppHealthUpdateApplitacionLanguages } from '../app-health.types';
...
export class ApplicationLanguageService
{
    ...
    applitacionLanguagesSubject$: BehaviorSubject<AppHealthApplicationLanguage[] | null> = new BehaviorSubject(null);
    ...
    */
    ...
    get applitacionLanguages$(): Observable<AppHealthApplicationLanguage[]>
    {
        return this.applitacionLanguagesSubject$.asObservable();
    }
    ...
    }>
    {
        return this.graphqlService
            ...
            .pipe(
                ...
                tap(data =>
                {
                    this.applitacionLanguagesSubject$.next(data.objects);
                }),
            );
    }
    ...
    update<T>(
        {
            ...
            graphqlStatement?: DocumentNode;
            object?: AppHealthUpdateApplitacionLanguages;
            query?: QueryStatement;
            constraint?: QueryStatement;
            headers?: GraphQLHeaders;
        } = {},
