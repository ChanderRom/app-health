...
export class ApplicationDatabaseDetailComponent extends ViewDetailComponent
{
    ...
    createForm(): void
    {
        this.fg = this.fb.group({
            ...
            size: [null, [Validators.required, Validators.maxLength(20)]],
            score: [null, [Validators.required, Validators.maxLength(10)]],
            totalCollectionTables: [null, [Validators.required, Validators.maxLength(10)]],
            totalFields: [null, [Validators.required, Validators.maxLength(10)]],
        });
    }
